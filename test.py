...
m1, _ = test_structure.add_member(
    length=0.5, rho=1, cross_section_area=1, youngs_modulus=1, inertia=1
)
m2, _ = test_structure.add_member(
    length=0.5, rho=1, cross_section_area=1, youngs_modulus=1, inertia=1
)
m3, _ = test_structure.add_member(
    length=1, rho=1, cross_section_area=1, youngs_modulus=1, inertia=1
)
